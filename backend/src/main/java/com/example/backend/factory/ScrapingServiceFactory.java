...
public class ScrapingServiceFactory {
    ...
    public void init() throws Exception {
        try {
            Map<String, IScrapingServiceStrategy> beans = applicationContext
                    .getBeansOfType(IScrapingServiceStrategy.class);
    ...
    public void registerScrapingStrategy(String strategyName, IScrapingServiceStrategy strategy) throws Exception {
        try {
            ...
            log.error("Error registering scraping strategy", e);
            throw new Exception(e.getMessage());
        }
    }
